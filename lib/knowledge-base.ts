...
export const TEST_KNOWLEDGE: Record<number, TestKnowledge> = {
  ...
  6: {
    ...
    useCases: ["Депресс", "Түгшүүр", "Стресс", "Сэтгэл санаа муу", "Уйтгар гуниг"],
    relatedTests: [8, 4],
    keywords: ["сэмүт", "сэтгэц", "депресс", "түгшүүр", "mental health", "стресс"]
  },
  7: {
    id: 7,
  ...
  8: {
    ...
    useCases: ["Санаа зовнил", "Түгшүүр", "Panic attack", "Нойргүйдэл"],
    relatedTests: [6, 2],
    keywords: ["түгшүүр", "anxiety", "санаа зовнил", "gad", "panic", "сандрал"]
  },
  10: {
    id: 10,
