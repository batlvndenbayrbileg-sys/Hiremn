...
export const CATEGORY_KEYWORDS: Record<string, RegExp> = {
  // hire.mn API-д байгаа үндсэн категориуд (exact match)
  'Өөрийн үнэлгээ':       /өөрийн үнэлгээ|өөрийгөө үнэл|self.?assess|өөрийнхөө|миний үнэлгээ|өөрийгөө танин мэд/i,
  'Зан төлөвийн тест':     /зан төлөв|зан чанар|personality|хэв шинж|character|зан.?аа|байдал.?аа/i,
  'Психометрик тест':      /психометрик|psychometric|оюун ухаан|iq|iq тест|оюуны чадвар|танин мэдэхүй/i,
  
  // Сэтгэл зүйн асуудлууд → Өөрийн үнэлгээ эсвэл Зан төлөв
  'сэтгэл':                /сэтгэл зүй|сэтгэц|mental|stress|стресс|түгшүүр|сэтгэлийн|гутрал|депресс|санаа зов|уйтгар|burnout|шаталт/i,
  
  // Харилцааны асуудлууд → Зан төлөвийн тест
  'харилцаа':              /харилцаа|communicat|эмпат|нийгмийн|social|хамт олон|найз нөхөд|хос|гэр бүл|хамтрагч/i,
  
  // Эрүүл мэндийн асуудлууд → Өөрийн үнэлгээ (AUDIT, Никотин гэх мэт)
  'эрүүл мэнд':            /эрүүл мэнд|health|никотин|тамхи|архи|audit|дарс|уух|тамхидах|согтуурах|донтолт|хамаарал/i,
  
  // Ажил, карьертай холбоотой → Зан төлөв эсвэл Психометрик
  'ажил':                  /ажил|мэргэжил|career|leadership|манаж|удирд|ажлын байр|ажилд орох|resume|cv|ярилцлага|interview/i,
  
  // Амьдралын тэнцвэр → Өөрийн үнэлгээ
  'тэнцвэр':               /тэнцвэр|balance|амьдрал|амралт|work.?life|амьдрал.?ажил|цаг хуваарь|амрах|ачаалал/i,
  
  // Хувийн хөгжил → Зан төлөв, Психометрик
  'хөгжил':                /хувийн хөгжил|өсөлт|growth|mindset|сэтгэлгээ|хандлага|өөрийгөө хөгж|суралц/i,
}
