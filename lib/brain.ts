...
3. ТЕСТ САНАЛ БОЛГОХ - ХАМГИЙН ЧУХАЛ:
   - Тестийн нэр + [TEST:id] хоёулаа явуулах
   - Жагсаалт хэлбэрээр:
   - Ажилын байран дээрх стрессийг илрүүлэх тест [TEST:6]
   - СЭМҮТ шалгаруулалт [TEST:2]
   
   ЭСВЭЛ текст дотор:
   Ажилын байран дээрх стрессийг илрүүлэх тест [TEST:6], СЭМҮТ шалгаруулалт [TEST:2], түгшүүрийг үнэлэх [TEST:8].
...
4. ХОРИГЛОХ:
  ...
  const intentGuides: Record<Intent, string> = {
    faq: `Товч хариул + тестийн нэр + [TEST:id].`,

    recommend: `Асуудлыг ойлгосноо 1 өгүүлбэрээр хэл + жагсаалт хэлбэрээр тестүүдийг (нэр + [TEST:id]).

ЖИШЭЭ:
Таны стрессийн асуудалд дараах тестүүд тохирно:
- Ажилын байран дээрх стрессийг илрүүлэх тест [TEST:6]
- СЭМҮТ шалгаруулалт [TEST:2]
- Түгшүүрийг үнэлэх тест [TEST:8]`,

    analyze: `Үр дүнг тайлбарла + дараагийн алхам + тестийн нэр + [TEST:id].`,

    upsell: `Холбогдох тестүүд (нэр + [TEST:id]).`,

    general: `Товч хариулт + жагсаалт (тестийн нэр + [TEST:id]).`
  }
