        ...
        <section className="relative min-h-screen flex items-center justify-center px-6">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-foreground tracking-tight text-balance">
              ...
              <br />
              <span className="text-foreground/80">Зөв хүн, зөв газарт</span>
            </h1>

            {/* Subheadline */}
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
              Монголын анхны мэргэжлийн үнэлгээ болон авьяас чадварын платформ. 
              42+ тест, 3,500+ хэрэглэгч.
            </p>
            ...
            <div className="pt-12 grid grid-cols-3 gap-8 max-w-lg mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground mt-1">Тестүүд</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary">3.5K+</div>
                <div className="text-sm text-muted-foreground mt-1">Хэрэглэгч</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary">98%</div>
                <div className="text-sm text-muted-foreground mt-1">Сэтгэл ханамж</div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Бид танд өөрийгөө илүү сайн мэдэхэд туслана
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-background rounded-2xl p-8 border border-border hover:border-primary/30 transition-colors duration-200">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Ухаалаг AI</h3>
                <p className="text-muted-foreground leading-relaxed">
                  AI-д суурилсан зөвлөгөө, таны үр дүнг гүнзгий задлан шинжилнэ.
                </p>
              </div>
              ...
              <div className="bg-background rounded-2xl p-8 border border-border hover:border-primary/30 transition-colors duration-200">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Дэлгэрэнгүй тайлан</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Тест бүрт нарийвчилсан тайлан, график, хөгжлийн зөвлөмж.
                </p>
              </div>
              ...
              <div className="bg-background rounded-2xl p-8 border border-border hover:border-primary/30 transition-colors duration-200">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3">Найдвартай</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Таны мэдээлэл бүрэн нууцлагдсан, аюулгүй байршилд хадгалагдана.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-primary to-accent rounded-3xl p-12 md:p-16 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-white/80 max-w-xl mx-auto mb-8">
                  Баруун доод буланд байгаа туслах-тай ярилцаж, өөрт тохирох тестийг олоорой!
                </p>
        ...
        <footer className="py-8 px-6 border-t border-border">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              Зөв хүн, зөв газарт — Right person, right place
            </p>
          </div>
        </footer>
      </div>
