...
function BrainAvatar() {
  return (
    <div style={{
      ...
      <img src="/mascot.png" alt="AI" className="hw-mascot-float" style={{ width: 32, height: 32, objectFit: "cover" }} />
    </div>
  )
}
...
export default function HireMnChatWidget({ initialContext }: HireMnChatWidgetProps = {}) {
  ...
  const [activeTab, setActiveTab] = useState<"chat" | "faqs" | "contact">("chat")
  ...
  background: #FFFFFF !important;
      ...
      <div className="hw-root" style={{
        ...
        {isOpen && (
          <div style={{ animation: "hw-chat-open 0.4s cubic-bezier(.34,1.56,.64,1)" }}>
            <div className="hw-panel" style={{
              ...
              borderRadius: 24,
              background: "#1A1A1A",
              boxShadow: "0 25px 60px rgba(0,0,0,.4), 0 10px 30px rgba(0,0,0,.2)",
              display: "flex", flexDirection: "column",
              border: "1px solid rgba(255,255,255,0.08)",
            }}>

              {/* Header with Tabs - PeachWeb style */}
              <div style={{
                background: "#1A1A1A",
                padding: "16px 20px 0",
                  ...
                  <div style={{ display: "flex", gap: 24 }}>
                    <button
                      ...
                      style={{
                        ...
                        color: activeTab === "chat" ? "#E8541A" : "rgba(255,255,255,0.5)",
                        fontSize: 14, fontWeight: 500, cursor: "pointer",
                        borderBottom: activeTab === "chat" ? "2px solid #E8541A" : "2px solid transparent",
                        transition: "all 0.2s",
                      }}
                    >
                      Chat
                    ...
                    <button
                      ...
                      style={{
                        background: "none", border: "none", padding: "8px 0",
                        color: activeTab === "faqs" ? "#E8541A" : "rgba(255,255,255,0.5)",
                        fontSize: 14, fontWeight: 500, cursor: "pointer",
                        borderBottom: activeTab === "faqs" ? "2px solid #E8541A" : "2px solid transparent",
                        transition: "all 0.2s",
                      }}
                    >
                      FAQs
                    ...
                    <button
                      ...
                      style={{
                        background: "none", border: "none", padding: "8px 0",
                        color: activeTab === "contact" ? "#E8541A" : "rgba(255,255,255,0.5)",
                        fontSize: 14, fontWeight: 500, cursor: "pointer",
                        borderBottom: activeTab === "contact" ? "2px solid #E8541A" : "2px solid transparent",
                        transition: "all 0.2s",
                      }}
                    >
                      Contact
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  onBlurCapture={e => {
                    (e.currentTarget as HTMLElement).style.borderColor = "#EAE0D9"
        ...
        {/* Mascot button - PeachWeb pill style */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 0, padding: 10 }}>
          <button
            className="hw-mascot"
